...
# <h1 align=center> **PRESENTACIÓN PROYECTO INDIVIDUAL Nº1 HENRY - DATA SCIENCE** </h1>
...
¡A continuación les presento el primer proyecto individual desarrollado para el proceso de aprobacion y evaluación de conocimenotos en Ciencia de Datos de SoyHenry de la etapa de labs! En el cual me he ubicado bajo el rol de de un ***MLOps Engineer***.  
...
Se requiere proveer un servicio de agregador web que permita hacer consultas especificas y genere recomendaciones al rededor del la data historica de Peliculas y Series Cinematograficas. Este proyecto lleva a la realizada este tipo de servicios muy demandados particularmente por plataformas de Videos en Streaming.
...
Como **`Data Scientist`** en una empresa que provee servicios de agregación de plataformas de streaming abordo este reto a traves de las bases de datos accesibles pero de forma preliminar he identificado que los mismos no cuentan con la debida depuracion encontrando por ejemplo Datos anidados, sin transformar, falta de procesos automatizados para la actualización de nuevas películas o series, entre otras cosas….  haciendo de esto un reto interesante :muscle:. 

Iniciamos con el rol de **`Data Engineer`** con el objetivo de tener un **`MVP`** (_Minimum Viable Product_) para las próximas semanas!
